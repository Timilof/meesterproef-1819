...
We also had the opportunity to speak with Nanne the responsible for the creation of the huge dataset where all individual shots were linked to other shots. A very cool learning moment where we were shown what was possible with the data, the actual complexity of the dataset and with this we were able to get a grip on the possibilities and limitations.
...
Mainly worked on the interface and making it scale to smaller sizes and had been wokring on a tutorial screen whih would explain the application to first time users.
...
# List of feedback maybe? Dropdown somewhere???
